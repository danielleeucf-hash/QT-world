...
const QT_LIBRARY = [
  {
    ...
    meditation: "예수님은 우리를 익명으로 다루지 않으시고 이름을 불러 인도하시는 선한 목자이십니다. 오늘 내가 따라야 할 음성이 무엇인지 분별하고, 나를 살리기 위해 생명을 내어주신 주님의 사랑 안에 머무르십시오.",
  ...
  },
  {
    ...
    meditation: "염려는 미래를 통제하려는 마음에서 자라지만, 믿음은 아버지께서 이미 아신다는 고백에서 시작됩니다. 오늘의 본문은 걱정을 부정하지 않고 우선순위를 하나님 나라로 다시 세우라고 부릅니다.",
  ...
  },
  {
    ...
    meditation: "복음은 예배당 안의 고백에 머물지 않고 몸과 관계와 선택을 새롭게 합니다. 산 제사로 드리는 삶은 악을 악으로 갚지 않고, 선으로 악을 이기는 구체적인 사랑으로 드러납니다.",
